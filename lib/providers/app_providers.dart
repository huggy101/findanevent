...
final w3wServiceProvider = Provider((_) => What3WordsService(Env.what3WordsApiKey));


final settingsRepoProvider = Provider((_) => SettingsRepository());
final venueEventRepoProvider = Provider((ref) => VenueEventRepository(ref.read(firestoreServiceProvider)));
